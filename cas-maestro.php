...
class CAS_Maestro {
	...
	function validate_login($null, $username, $password) {
		...
		// add information from CAS
		$firstname = phpCAS::hasAttribute('givenName')?utf8_decode(phpCAS::getAttribute('givenName')):'';
        $lastname = phpCAS::hasAttribute('sn')?utf8_decode(phpCAS::getAttribute('sn')):'';
        $user_email = phpCAS::hasAttribute('ENTPersonMailInterne')?phpCAS::getAttribute('ENTPersonMailInterne'):'';
        //$profil = phpCAS::hasAttribute('ENTPersonProfils')?phpCAS::getAttribute('ENTPersonProfils'):'National_7';
        $profil = '';
